...
use hunomina\Routing\Auth\Test\User\SuperAdmin;
...
class SuperAdminAccessTest extends TestCase
{
    ...
    /**
     * SuperAdminAccessTest constructor.
     ...
     * @throws RoutingException
     */
    public function testAccessToSuperAdminPage(): void
    {
        // login
        $user = new SuperAdmin();
        $_SESSION['auth'] = serialize($user);
     ...
     * @throws RoutingException
     */
    public function testAccessToUserPage(): void
    {
        // login
        $user = new SuperAdmin();
        $_SESSION['auth'] = serialize($user);
    ...
    public function testPutOnlyWithGet(): void
    {
        ...
        $this->assertInstanceOf(HtmlResponse::class, $response);
        $this->assertEquals(404, $response->getHttpCode()); // no auth but route does not exist => 404
    }
